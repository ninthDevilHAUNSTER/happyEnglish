# Generated by Django 2.0.13 on 2019-04-14 18:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('en', models.CharField(default=' ', help_text='en : 请在此输入英文', max_length=200, verbose_name='英语')),
                ('cn', models.CharField(default=' ', help_text='cn : 请在此输入中文', max_length=200, verbose_name='中文')),
